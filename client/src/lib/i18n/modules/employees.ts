...
export const employeesTranslations: { [key: string]: EmployeesTranslations } = {
  ko: {
    ...
    addEmployeeHint: "위의 '직원 추가' 버튼을 클릭하여 첫 번째 직원을 추가하세요",
  ...
  en: {
    ...
    addEmployeeHint: "Click 'Add Employee' button above to add your first employee",
  ...
  vi: {
    ...
    addEmployeeHint: "Nhấp vào nút 'Thêm nhân viên' ở trên để thêm nhân viên đầu tiên",
