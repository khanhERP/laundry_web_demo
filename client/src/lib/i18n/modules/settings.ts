...
export const settingsTranslations: { [key: string]: SettingsTranslations } = {
  ko: {
    ...
    productCreatedSuccess: "상품이 성공적으로 생성되었습니다",
  ...
  en: {
    ...
    productCreatedSuccess: "Product has been created successfully",
  ...
  vi: {
    ...
    productCreatedSuccess: "Sản phẩm đã được tạo thành công",
