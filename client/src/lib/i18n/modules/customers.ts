...
export const customersTranslations: { [key: string]: CustomersTranslations } = {
  ...
  en: {
    ...
    people: "people",
    customerUpdated: "Customer information has been updated",
  ...
  vi: {
    ...
    customerUpdated: "Cập nhật thông tin khách hàng thành công",
    ...
    people: "người",
    customerUpdated: "Thông tin khách hàng đã được cập nhật",
