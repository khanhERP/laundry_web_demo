...
export function CustomerFormModal({ isOpen, onClose, customer, initialPhone }: CustomerFormModalProps) {
  ...
  const { data: orderHistory, isLoading: ordersLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest("GET", `https://laundry-be-demo.onrender.com/api/orders`);
  ...
  const generateCustomerId = async () => {
    try {
      const response = await apiRequest("GET", "https://laundry-be-demo.onrender.com/api/customers/next-id");
  ...
  const createMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      ...
      const response = await apiRequest("POST", "https://laundry-be-demo.onrender.com/api/customers", cleanData);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      ...
      const response = await apiRequest("PUT", `https://laundry-be-demo.onrender.com/api/customers/${customer.id}`, cleanData);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://laundry-be-demo.onrender.com/api/customers"] });
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    if (customer?.id) {
      ...
      if (!customerIdToUse || customerIdToUse === t('common.autoGenerated')) {
        try {
          const response = await fetch('https://laundry-be-demo.onrender.com/api/customers/next-id');
