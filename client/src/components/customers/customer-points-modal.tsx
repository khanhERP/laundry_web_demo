...
export function CustomerPointsModal({
  ...
  const { data: pointsData, isLoading: pointsLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://9be1b990-a8c1-421a-a505-64253c7b3cff-00-2h4xdaesakh9p.sisko.replit.dev/api/customers/${customerId}/points`);
  ...
  const { data: pointHistory, isLoading: historyLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://9be1b990-a8c1-421a-a505-64253c7b3cff-00-2h4xdaesakh9p.sisko.replit.dev/api/customers/${customerId}/point-history`);
