  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (receiptData.orderId && receiptData.orderId !== 'temp-order') {
        ...
        try {
          const statusResponse = await fetch(`https://laundry-be-demo.onrender.com/api/orders/${receiptData.orderId}/status`, {
            method: 'PUT',
            headers: {
      ...
      try {
        ...
        const printApiResponse = await fetch('https://laundry-be-demo.onrender.com/api/pos/print-receipt', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
