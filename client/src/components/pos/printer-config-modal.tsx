...
export function PrinterConfigModal({
  ...
  const { data: printerConfigs = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiRequest("GET", "https://9be1b990-a8c1-421a-a505-64253c7b3cff-00-2h4xdaesakh9p.sisko.replit.dev/api/printer-configs");
  ...
  const createConfigMutation = useMutation({
    mutationFn: async (configData: any) => {
      const response = await apiRequest(
        "POST",
        "https://9be1b990-a8c1-421a-a505-64253c7b3cff-00-2h4xdaesakh9p.sisko.replit.dev/api/printer-configs",
        configData,
      );
      return response.json();
    },
    onSuccess: () => {
      ...
      queryClient.refetchQueries({ queryKey: ["https://9be1b990-a8c1-421a-a505-64253c7b3cff-00-2h4xdaesakh9p.sisko.replit.dev/api/printer-configs"] });
